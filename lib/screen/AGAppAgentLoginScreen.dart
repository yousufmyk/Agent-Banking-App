...
import 'AgAppForgotPasswordScreen.dart';
...
class WALoginScreenState extends State<WALoginScreen> {
  ...
  Widget build(BuildContext context) {
    final _controller = Get.put(AgentLoginController());
    return Scaffold(
      appBar: AppBar(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        //await sendOtp();
                                        //AGAppForgotPasswordScreen().launch(context);
                                      },
                                      child: Text("Forgot User Name?",
