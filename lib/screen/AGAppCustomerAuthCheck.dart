...
import 'AGAppCustomerLoginScreen.dart';
import 'AGAppAgentLoginScreen.dart';

class AGAPPCustomerAuthCheckScreen extends StatefulWidget {
  const AGAPPCustomerAuthCheckScreen({Key? key}) : super(key: key);

  @override
  State<AGAPPCustomerAuthCheckScreen> createState() =>
      _AGAPPCustomerAuthCheckScreenState();
}

class _AGAPPCustomerAuthCheckScreenState extends State<AGAPPCustomerAuthCheckScreen> {
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        ...
                        AGAppCustomerLoginScreen().launch(context);
                      },
                      child: Container(
                        width: 250,
                        height: 50,
