...
class AGAppEditProfileScreen extends StatefulWidget {
  // final CreditCardModel data;
  // const AGAppEditProfileScreen({
  ...
  @override
  AGAppEditProfileScreenState createState() =>
      AGAppEditProfileScreenState(/*data: data*/);
}

class AGAppEditProfileScreenState extends State<AGAppEditProfileScreen> {
  // AGAppEditProfileScreenState({
  //   required this.data,
  // }) : assert(data != null);
  // final CreditCardModel data;
