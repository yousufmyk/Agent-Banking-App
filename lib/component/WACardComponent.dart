...
class WACardComponent extends StatefulWidget {
  ...
  const WACardComponent({Key? key, required this.data, required this.cardModel})
      : assert(data != null),
        super(key: key);
          ...
          Row(
            ...
            children: [
                ...
                onTap: () {
                  if (isSwitched == false) {
                    ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Your card is disabled')));
                  }
                },
                child: Switch(
              ...
              GestureDetector(
                  ...
                  child: /*Text("Reveal \n Details",
                    style: primaryTextStyle(color: Colors.white70)),*/
                      Image(image: AssetImage("images/mobile_banking/eye.png"),color: Colors.white70,)),
            ],
          )
        ],
      ),
