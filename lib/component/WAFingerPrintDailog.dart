...
import '../screen/AGAppExistingAgentScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Text("Dual Authentication Login",
          ...
          AppButton(
            ...
            onTap: () async {
              ...
              if (emiD == true) {
                ...
                return  AGAppFinancialScreen(/*data:widget.data,*/).launch(context);
                }
              } else if (emiD == false)
               // isAuthenticated = await FingerPrintComponent().authenticate();
              print("Error");
      ...
      buttons: [
        DialogButton(
          onPressed: () {
            ...
            //   data: data,
            // ).launch(context);
            // AGAppExistingAgentOnboardingScreen().launch(context);
