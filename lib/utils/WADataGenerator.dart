...
import 'package:mobile_banking/screen/WABillPayScreen.dart';
import 'package:mobile_banking/screen/WACreditCardScreen.dart';
import 'package:mobile_banking/screen/WASendMoneyViaLoopScreen.dart';
import 'package:mobile_banking/screen/WAVoucherScreen.dart';
...
List<WARecentPayeesModel> waRecentPayeesList() {
  ...
  list.add(WARecentPayeesModel(
      image:
          'https://softposreceipt.omaemirates.com:8988/SoftPOS/mobile_bank/ghulam.png',
      name: 'Ghulam',
      number: '05012456'));
  list.add(WARecentPayeesModel(
      image:
